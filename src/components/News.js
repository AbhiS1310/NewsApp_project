...
const News = (props) => {
    ...
    const updateNews = async () => {
        props.setProgress(0);
        var url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=886960eb2088499e81c01e2abc72e434&page=${page}&pagesize=${props.pagesize}`;
